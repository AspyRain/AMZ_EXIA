...
#define EF_WRITE_GRAN           (8) /* 必须定义的一个值 */
...
// 定义扇区大小
#define STM_SECTOR_SIZE_16KB (1024 * 16)
#define STM_SECTOR_SIZE_64KB (1024 * 64)
#define STM_SECTOR_SIZE_128KB (1024 * 128)

#define STM32_SECTOR_5_START 0x080200000UL
#define STM32_SECTOR_6_START 0x080400000UL

#define EF_START_ADDR          (STM32_FLASH_BASE+STM_SECTOR_SIZE*16*4)   /* 必须定义的一个值 */
